    ...
    */
    describe('cypress/e2e/generated/CASE-1/regression-10', () => {
...
action:dropdown:select - {"options":["driver","doctor","teacher"],"selectedOption":"driver"}
check:screenshot - 
action:form:submit - 
check:screenshot - 
 ...
 */
        ...
        it('Test body', function() {
          const specFile = __filename;
			...
			cy.log('**Step [4/8]:** action:dropdown:select - {"options":["driver","doctor","teacher"],"selectedOption":"driver"}');
		

						cy.get('select[data-test-id="profession"]').select('driver');
